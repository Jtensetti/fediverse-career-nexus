	...
	theme: {
		...
		fontFamily: {
			...
			keyframes: {
				...
				glow: {
					'0%, 100%': { boxShadow: '0 0 15px hsl(var(--tier-gold) / 0.3)' },
					'50%': { boxShadow: '0 0 30px hsl(var(--tier-gold) / 0.5)' }
				}
			},
			animation: {
				...
				'shimmer-gold': 'shimmerGold 3s infinite',
				'unlock-bounce': 'unlockBounce 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
