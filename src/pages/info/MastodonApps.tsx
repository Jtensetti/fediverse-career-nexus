...
export default function MastodonApps() {
  return <div className="mx-auto max-w-2xl space-y-6 px-5 py-12">
    ...
    <p>Stödet för Mastodon-appar testas just nu med utvalda Nolto-konton. Det är ännu inte öppet för alla. Inloggning, profil och hemflöde har provats i Phanpy.</p>
    <p>Om ditt konto ingår i testet väljer du nolto.social som server i appen. Du loggar in på Noltós webbplats med din vanliga inloggningsmetod och väljer om appen ska få åtkomst. Din Nolto-adress är densamma även när du använder Google, Apple eller Bluesky för inloggningen.</p>
