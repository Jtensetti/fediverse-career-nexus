...
const ActorOutbox = () => {
  ...
  useEffect(() => {
    // On mount, check if we need to redirect to the outbox JSON endpoint
    ...
    if (typeof window !== "undefined" && window.fetch) {
      ...
      if (
        ...
        window.location.href = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/outbox/${username}`;
      } else {
