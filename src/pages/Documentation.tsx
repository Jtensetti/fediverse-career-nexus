...
const Documentation = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        title="Documentation" 
        description="Everything you need to get started with Nolto, from creating your profile to running your own federated instance." 
      />
      {/* Header */}
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-primary mb-6">1. Getting Started</h2>
            
            <h3 className="text-xl font-semibold text-primary mb-4">Creating an Account</h3>
            ...
            <h3 className="text-xl font-semibold text-primary mb-4">Completing Your Profile</h3>
            <ul className="space-y-2 mb-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-primary mb-6">2. Finding Jobs & Opportunities</h2>
            <ul className="space-y-2 mb-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-primary mb-6">3. Federation: How It Works</h2>
            ...
            <h3 className="text-xl font-semibold text-primary mb-4">Choosing an Instance</h3>
            <ul className="space-y-2 mb-6">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-primary mb-6">4. Running Your Own Instance</h2>
            <ul className="space-y-2 mb-6">
              <li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-primary mb-6">5. More Resources</h2>
            <div className="bg-muted p-6 rounded-lg">
              <ul className="space-y-3">
                <li>
                  <strong className="text-primary">Help Center</strong> – FAQ and troubleshooting
                </li>
                <li>
                  <strong className="text-primary">How Federation Works</strong> – Deep dive into federation and ActivityPub
                </li>
                <li>
                  <strong className="text-primary">Instance Guidelines</strong> – Rules for hosting your own Nolto server
                </li>
                <li>
