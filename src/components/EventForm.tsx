          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>URL to an image for the event banner</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between space-x-2 rounded-lg border p-4">
                <div>
                  ...
                  <FormDescription>Will this event be held online?</FormDescription>
                </div>
                <FormControl>
                  <Switch
                    checked={field.value}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. 123 Main St, City, Country" {...field} value={field.value || ""} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="https://meet.example.com/..." {...field} value={field.value || ""} />
                  </FormControl>
                  <FormDescription>Link to your online meeting (Jitsi, Galène, etc.)</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Set a maximum number of attendees (optional)</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Control who can discover and attend your event</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
